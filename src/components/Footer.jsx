        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
              A modern React application built with Tailwind CSS for managing tasks and displaying API data. 
              Demonstrates component architecture, state management, and responsive design.
            </p>
